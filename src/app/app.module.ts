...
import { InsertPersonalReservationComponent } from './reservation/insert-personal-reservation/insert-personal-reservation.component';
...
@NgModule({
  declarations: [
    ...
    InsertPersonalReservationComponent,
